defmodule ProjectInfoTest do
  ...
  test "invalid date format" do
    ...
    warn_first = "\x1b[33m * Invalid date format string `date_format`:\x1b[0m"
    warn_last = "\x1b[33m * The default format string will be used instead.\x1b[0m\n"
  ...
  test "invalid list title format" do
    ...
    warn_first = "\x1b[33m * Invalid post list title format string"
    assert String.starts_with?(warn, warn_first)
